...
public class AuthenticationFilter implements Filter {
	...
	private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// Extract username and verify user changed to id extract userid and verify user
		int id = Integer.parseInt(authService.extractUserId(token));
		...
		//for admin logout
		if(requestURI.contains("/api/auth/logout") && role == Role.ADMIN) {
